...
`placeholder-7.jpg` … `placeholder-46.jpg` are real customer-vehicle photos.
(The original `placeholder-1.jpg` … `placeholder-6.jpg` "Photo Coming Soon"
tiles have been removed now that real photos are live.)

| File | Recommended |
|------|-------------|
| `placeholder-7.jpg` … `placeholder-46.jpg` | JPG, 1200×900, landscape (4:3). Keep the exact same file names. |
